...
task tcase_trfer_bulkint;
  ...
  fork
    ...
    `tenv_usbhost.trsac_in.pack_size=1;
    ...
    `tenv_usbhost.trsac_in.ep=ep;
    `tenv_usbhost.trsac_in.pack_size=6;
    `tenv_usbhost.trsac_in.buffer_ptr=i;
    `tenv_usbhost.trsac_in.mode=`tenv_usbhost.HSK_NAK;
    `tenv_usbhost.trsac_in;
    i=i+6;
    ...
    `tenv_usbdev.trsac_in.pack_size=1;
    ...
    `tenv_usbdev.trsac_in.ep=ep;
    `tenv_usbdev.trsac_in.pack_size=6;
    `tenv_usbdev.trsac_in.buffer_ptr=j;
  ...
  fork
    ...
    `tenv_usbhost.trsac_in.ep=ep;
    `tenv_usbhost.trsac_in.pack_size=3;
    `tenv_usbhost.trsac_in.buffer_ptr=i;
    `tenv_usbhost.trsac_in.mode=`tenv_usbhost.HSK_STALL;
    `tenv_usbhost.trsac_in;
    i=i+3;
    ...
    `tenv_usbdev.trsac_in.ep=ep;
    `tenv_usbdev.trsac_in.pack_size=3;
    `tenv_usbdev.trsac_in.buffer_ptr=j;
  ...
  packet_size=1;
  $write("%0t [%0s]: ",$realtime,block_name);
  $display("# BulkIn(ep=%0d) with host doesn't reply by handshake)",ep);
  fork
    begin
    i=0;
    `tenv_usbhost.trsac_in.ep=ep;
  ...
  fork
    ...
    `tenv_usbhost.trsac_out.pack_size=packet_size;
    `tenv_usbhost.trsac_out.buffer_ptr=i*packet_size;
    `tenv_usbhost.trsac_out.mode=`tenv_usbhost.HSK_NAK;
    `tenv_usbhost.trsac_out;
  ...
  fork
    ...
    `tenv_usbhost.trsac_out.pack_size=packet_size;
    `tenv_usbhost.trsac_out.buffer_ptr=i*packet_size;
    `tenv_usbhost.trsac_out.mode=`tenv_usbhost.HSK_STALL;
    `tenv_usbhost.trsac_out;
  ...
  repeat(15)
    ...
    repeat(15)
      fork
        ...
        //HOST DOESN'T SEND ACK BUT CHANGE TOGGLE BIT
        //DUT DOESN'T CARE ABOUT RECEIVING ACK
        i=i+1;
        `tenv_usbhost.trsac_in.ep=ep;
        `tenv_usbhost.trsac_in.pack_size=packet_size;
        `tenv_usbhost.trsac_in.buffer_ptr=i*packet_size;
  ...
  fork
    begin
    `tenv_usbhost.reqstd_setconf.conf_value=i;
    `tenv_usbhost.reqstd_setconf.mode=`tenv_usbhost.REQ_STATSTALL;
    `tenv_usbhost.reqstd_setconf;
    end

    begin
    `tenv_usbdev.reqstd_setconf.conf_value=i;
    `tenv_usbdev.reqstd_setconf.status=`tenv_usbdev.STALL;
    `tenv_usbdev.reqstd_setconf;
    end
  join
  //CHECK PID DATA1
  ...
  fork
    ...
    `tenv_usbdev.reqstd_clrfeat.status=`tenv_usbdev.ACK;
    ...
    `tenv_usbhost.reqstd_clrfeat.mode=`tenv_usbhost.REQ_OK;
  ...
  fork
    ...
    `tenv_usbdev.reqstd_clrfeat.ep=5;
    `tenv_usbdev.reqstd_clrfeat.ep_dir=0;
    `tenv_usbdev.reqstd_clrfeat.status=`tenv_usbdev.STALL;
    `tenv_usbdev.reqstd_clrfeat;
    end
    ...
    `tenv_usbhost.reqstd_clrfeat.ep=5;
    `tenv_usbhost.reqstd_clrfeat.ep_dir=0;
    `tenv_usbhost.reqstd_clrfeat.mode=`tenv_usbhost.REQ_STATSTALL;
    `tenv_usbhost.reqstd_clrfeat;
    end
  join
  //CHECK PID DATA1
